  ...
  return (
    <div >
      <div className="relative shadow-sm">
        ...
        <input ref={searchInput} type="search" placeholder="Filter" aria-label="Global search box" className="rounded border outline-none h-10 block w-full pl-4 sm:text-sm sm:leading-5" />
      </div>
    </div>
  )
