  ...
  return (
    <div className="relative mt-8">
      ...
      <blockquote className="mt-4">
        <div className="mx-auto text-center xl md:max-w-5xl text-xl md:text-4xl leading-12 font-medium text-gray-900">
          <p>
            {vision}
          </p>
        </div>
        <footer className="mt-4">
          <div className="flex items-center md:justify-center">
            ...
            <div className="ml-4">
              ...
              <div className="sm:text-xl mt-1 leading-6 font-medium text-gray-500">Development Manager at PLUS</div>
            </div>
          </div>
        </footer>
      </blockquote>
