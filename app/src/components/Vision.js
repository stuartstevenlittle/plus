...
const Vision = ({ vision }) => {
  ...
  return (
    <div className="relative mt-8">
      <svg className="absolute top-20 left-4 md:left-0 transform -translate-x-8 -translate-y-24 h-36 w-36 text-indigo-300 opacity-50" stroke="currentColor" fill="none" viewBox="0 0 144 144">
