    ...
    <footer className="bg-transparent text-gray-600 border-t">
      <div className="max-w-screen-xl mx-auto pb-3 sm:pb-4 pt-4 md:flex md:items-center md:justify-between">
        ...
        <div className="flex justify-center space-x-3 order-1 md:order-3">
          <a href="https://www.facebook.com/PlusPerth-1514503322206433/" target="_blank" rel="noreferrer" className="hover:text-blue-800 animate">
          ...
          <a href="https://twitter.com/PLUS_Perth" target="_blank" rel="noreferrer" className="hover:text-blue-400 animate">
